...
function display_sites()
{
    ...
    foreach ($_SESSION["user_sites"] as $site) {
        echo '<div class="card">
                <div class="card-body">
                    <p>Site Name: <a href="' . $site['sitelink'] . '" target="_blank" rel="noopener noreferrer">' . $site['sitename'] . '</a></p>
...
function display_fav_sites()
{
    ...
    foreach ($_SESSION["user_fav_sites"] as $site) {
        echo '<div class="card">
                <div class="card-body">
                    <a href="' . $site['sitelink'] . '" target="_blank" rel="noopener noreferrer">Site Name: ' . $site['sitename'] . '</a>
                    <p>Username: ' . $site['siteusername'] . '</p>
                    <p>Email: ' . $site['siteemail'] . '</p>
                    <p>Password: ' . $site['sitepwd'] . '</p>
                    <div class="icon-container">
